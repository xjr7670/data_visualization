...
def import_data(import_file):
    ...
    Expects so find fixed width row
    Sample row: 161322597 0386544351896 042
    '''
    ...
    with open(import_file, 'r') as f:
        for line in f:
            ...
            # strip any whitespace for each filed
...
if __name__ == '__main__':
    ...
    parser.add_argument("export_file", help="Export format: json, csv, xlsx.")
